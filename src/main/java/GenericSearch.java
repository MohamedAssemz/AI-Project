    ...
    private static int heuristic1(Node currentNode) {
    	...
    	if(LLAPSearch.prosperityBUILD1>LLAPSearch.prosperityBUILD2) {
           minBuild=prosDiff/LLAPSearch.prosperityBUILD1;
     	   minCost=minBuild*(LLAPSearch.priceBUILD1+LLAPSearch.foodUseBUILD1+LLAPSearch.materialsUseBUILD1+LLAPSearch.energyUseBUILD1);

    	}
    	else {
    	  minBuild=prosDiff/LLAPSearch.prosperityBUILD2;
    	  minCost=minBuild*(LLAPSearch.priceBUILD2+LLAPSearch.foodUseBUILD2+LLAPSearch.materialsUseBUILD2+LLAPSearch.energyUseBUILD2);
    	}
    	return minCost;
